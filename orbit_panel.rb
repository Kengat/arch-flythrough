# ============================================================
#  ARCH ORBIT (версия-скрипт с панелью)
#
#  Запуск:  Window -> Ruby Console ->
#     load "C:/dev/arch-flythrough/orbit_panel.rb"
#  Откроется панель. НЕ кладётся в Plugins -> при старте SketchUp
#  не грузится и не может ничего уронить.
#
#  Снимать: выдели линию, Старт, пиши экран Win+Alt+R (или OBS), Стоп.
# ============================================================
...
module ArchOrbit
  ...
  def self.show_panel
    ...
    @dialog = UI::HtmlDialog.new(
      ...
      :width => 300, :height => 380, :resizable => true,
  ...
  def self.html
    <<~HTML
      ...
      <style>
        ...
        <div class="hint">Выдели линию, потом «Старт». Запись экрана: Win+Alt+R.</div>
        <div id="status"></div>
      <script>
...
ArchOrbit.show_panel  # открыть панель сразу при запуске из консоли
